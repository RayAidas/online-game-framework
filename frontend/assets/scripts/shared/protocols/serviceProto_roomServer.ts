...
export interface ServiceType {
    ...
    msg: {
        ...
        "serverMsg/TurnChanged": MsgTurnChanged,
        "serverMsg/TurnTimeout": MsgTurnTimeout,
...
export const serviceProto: ServiceProto<ServiceType> = {
    ...
    "services": [
        ...
        {
            "id": 36,
            "name": "serverMsg/TurnChanged",
            "type": "msg"
        },
        {
            "id": 37,
            "name": "serverMsg/TurnTimeout",
            "type": "msg"
        },
        {
            "id": 8,
    ...
    "types": {
        ...
        "PtlEndTurn/ReqEndTurn": {
            "type": "Interface"
        },
        "PtlEndTurn/ResEndTurn": {
            "type": "Interface",
            "properties": [
                {
                    "id": 0,
        ...
        "PtlGetGameState/ReqGetGameState": {
            "type": "Interface"
        },
        "PtlGetGameState/ResGetGameState": {
            "type": "Interface",
            "properties": [
                {
                    "id": 0,
        ...
        "PtlSyncGameState/ReqSyncGameState": {
            "type": "Interface",
            "properties": [
                {
                    "id": 0,
        ...
        "PtlSyncGameState/ResSyncGameState": {
            "type": "Interface",
            "properties": [
                {
                    "id": 0,
        ...
        "serverMsg/MsgTurnChanged/MsgTurnChanged": {
            "type": "Interface",
            "properties": [
                {
                    "id": 0,
        ...
        "serverMsg/MsgTurnTimeout/MsgTurnTimeout": {
            "type": "Interface",
            "properties": [
                {
                    "id": 0,
