	...
	nodeSchema: {
		node: {
			...
			rows: [
				...
				{ name: 'WorldPosition.x', parentKey: 'worldPosition', key: 'x', type: 'object_number', method: 'setWorldPosition' },
				{ name: 'WorldPosition.y', parentKey: 'worldPosition', key: 'y', type: 'object_number', method: 'setWorldPosition' },
			]
		},
	},
	componentsSchema: {
